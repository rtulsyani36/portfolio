      ...
      <div className="max-w-7xl w-full px-4 md:px-6 relative z-10">
        ...
        <div className="bg-white/80 dark:bg-black/70 backdrop-blur-2xl rounded-xl border border-white/60 dark:border-white/10 shadow-deep overflow-hidden flex flex-col md:flex-row min-h-[600px] animate-fade-in-up">
            ...
            <div className="flex-1 flex flex-col bg-white dark:bg-[#111] relative">
                ...
                {/* Content Header */}
                <div className="h-16 border-b border-gray-100 dark:border-white/5 flex items-center justify-between px-8 bg-white/50 dark:bg-[#111]/50 backdrop-blur-sm z-10 sticky top-0">
                    ...
                    {/* Optional Action Button for specific experiences */}
                    {selectedExp.company.includes('YouTube') && (
                        <a 
                            href="https://www.youtube.com/@nonu36" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="w-8 h-8 flex items-center justify-center rounded-full bg-[#FF0000] text-white hover:scale-110 transition-transform shadow-md"
                            title="Visit Channel"
                        >
